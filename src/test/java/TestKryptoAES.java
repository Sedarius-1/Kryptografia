...
class TestKryptoAES {
    ...
    void TestAES192bitEncrypt() {
        ...
        byte[] expected_ciphertext = HexFormat.of().parseHex("feef0b557ea4c1e24b4bc480f779b123");
    ...
    void TestAES256bitEncrypt() {
        ...
        byte[] expected_ciphertext = HexFormat.of().parseHex("581a95f57098feb62cc90dcb95f839b7");
